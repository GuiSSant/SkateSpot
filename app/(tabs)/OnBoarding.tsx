    ...
    return (
      <View style={styles.container}>
        ...
        <Image style={styles.backgroundImage}
          source={
            onBoardingContent[count].image
          }
          blurRadius={2} />

        <Text style={styles.onBoardingText}>{onBoardingContent[count].mainText}</Text>
        <TouchableOpacity style={styles.button} onPress={onPress} >
          <Text style={styles.textButton}>{onBoardingContent[count].buttonText}</Text>
        </TouchableOpacity>
